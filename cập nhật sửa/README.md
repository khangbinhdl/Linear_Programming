...
Dự án này là một phần mềm giải bài toán Quy hoạch tuyến tính (Linear Programming), bao gồm giao diện Web trực quan và 2 bộ thuật toán cốt lõi:

1. **Giao diện Web (Streamlit):** Ứng dụng web trực quan giúp nhập bài toán nhanh chóng (hỗ trợ dạng phương trình inline), tùy chọn phương pháp giải, tùy chỉnh điều kiện dấu và xem kết quả/đồ thị một cách trực tiếp.
...
```text
.
├── frontend/                  # Chứa file giao diện web (Streamlit)
│   └── app.py
├── Graphical/                 # Thuật toán và vẽ đồ thị 2D (Matplotlib)
│   └── graphical_lp_2d.py
├── Simplex/                   # Thuật toán Simplex (Từ vựng)
│   └── simplex_dictionary_solver.py
├── README.md
└── requirements.txt           # Danh sách các thư viện cần thiết
```

## 2. Cài đặt và Khởi chạy Web

Dự án sử dụng Python thuần với framework **Streamlit** cho giao diện. Bạn không cần cài đặt các server phức tạp.
...
**Bước 2: Khởi chạy phần mềm** Chạy lệnh sau để bật giao diện Web:
